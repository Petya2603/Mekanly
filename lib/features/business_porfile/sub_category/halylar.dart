...
// class SubCategoryHaly extends StatelessWidget {
//   const SubCategoryHaly({super.key, required this.title});
//   final String title;
...
//                     title: 'Haly Namazlyk',
//                     icon: Assets.icons.icNamazlykGridView.svg(package: 'gen'),
//                   ),
//                 ),
//                 StaggeredGridTile.count(
//                   crossAxisCellCount: 3,
//                   mainAxisCellCount: 3,
//                   child: SubcategoryTile(
//                     title: 'Türkmen halylar',
//                     icon: Assets.icons.icTurkmenCarpetGridView.svg(package: 'gen'),
//                   ),
//                 ),
//                 StaggeredGridTile.count(
...
//                   mainAxisCellCount: 3,
//                   child: SubcategoryTile(
//                     title: 'Elde dokalan halylar',
//                     icon: Assets.icons.icHandCarpetGridView.svg(package: 'gen'),
//                   ),
//                 ),
//                 StaggeredGridTile.count(
//                   crossAxisCellCount: 2,
//                   mainAxisCellCount: 3,
//                   child: SubcategoryTile(
//                     title: 'Owadan gülli halylar',
//                     icon: Assets.icons.icFlowerCarpetGridView.svg(package: 'gen'),
//                   ),
//                 ),
//                 StaggeredGridTile.count(
//                   crossAxisCellCount: 2,
...
//                   child: SubcategoryTile(
//                     title: 'Diwarlyk haly',
//                     icon: Assets.icons.icWallCarpetGridView.svg(package: 'gen'),
//                   ),
//                 ),
//                 StaggeredGridTile.count(
//                   crossAxisCellCount: 2,
...
//                   child: SubcategoryTile(
//                     title: 'Haly sumka',
//                     icon: Assets.icons.icBagCarpetGridView.svg(package: 'gen'),
//                   ),
//                 ),
//                 StaggeredGridTile.count(
//                   crossAxisCellCount: 2,
...
//                     icon: Assets.icons.icDokmaProductGridView.svg(package: 'gen'),
//                   ),
//                 ),
//                 StaggeredGridTile.count(
//                   crossAxisCellCount: 2,
...
//                     icon: Assets.icons.icAwtoCarpetGridView.svg(package: 'gen'),
//                   ),
//                 ),
//               ],
//             ),
