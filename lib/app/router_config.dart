...
import '../features/business_porfile/business_profile.dart';
...
import '../features/houses/houses_view.dart';
    ...
    routes: [
      GoRoute(
        ...
        routes: [
          ...
          //     StatefulShellBranch(
          //       navigatorKey: homeShellNavigator,
          //       routes: <RouteBase>[
          //         GoRoute(
          ...
          //     ),
          //     StatefulShellBranch(
          //       navigatorKey: housesShellNavigator,
          //       routes: <RouteBase>[
          //         GoRoute(
          //           path: HousesView.routePath,
          //           name: HousesView.routeName,
          //           builder: (context, state) {
          //             return HousesView.builder();
          //           },
          //         ),
          //       ],
          //     ),
          //     StatefulShellBranch(
          //       navigatorKey: businessProfileShellNavigator,
          //       routes: <RouteBase>[
          //         GoRoute(
          //           path: BusinessProfileView.routePath,
          //           builder: BusinessProfileView.builder,
          //         ),
          //       ],
          //     ),
          //     StatefulShellBranch(
          //       navigatorKey: favoritesShellNavigator,
          //       routes: <RouteBase>[
          //         GoRoute(
          //           path: FavoritesView.routePath,
          //           builder: FavoritesView.builder,
          //         ),
          //       ],
          //     ),
          //     StatefulShellBranch(
          //       navigatorKey: menuShellNavigator,
          //       routes: <RouteBase>[
          //         GoRoute(
          //           path: MenuView.routePath,
